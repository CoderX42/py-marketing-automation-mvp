...
- **手机弹出 `io.appium.uiautomator2.server` 或“应用未备案”安装页**：这是 Appium 的自动化辅助服务。保持手机解锁，在弹窗中点击“了解风险/允许安装”（不要点“取消”），小米手机还要开启“USB 调试（安全设置）/通过 USB 安装”。新版已将安装和 ADB 等待时间延长到 120 秒。
