...
class MainWindow(QMainWindow):
    ...
    def start_batch(self):
        ...
        config = {
            ...
            "timing": {"between_records_seconds": self.interval.value(), "random_jitter_seconds": self.jitter.value(), "pause_every_records": self.batch_count.value(), "pause_minutes": self.batch_pause.value(), "page_timeout_seconds": 60, "input_page_timeout_seconds": 90, "uiautomator2_server_read_timeout_seconds": 60, "appium_command_timeout_seconds": 35, "network_retries": 2, "network_retry_seconds": 15},
        }
